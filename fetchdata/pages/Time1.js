      ...
      <ScrollView>
        <View style={styles.MainContainer}>
          <Text style={{ fontSize: 23, fontWeight: "bold" }}>
            Felicitation of Dawoodi Bohra Amil Saheb
          </Text>
          <View style={{ flexDirection: "row" }}>
            <Image
              style={{ width: 125, height: 125, marginLeft: 65 }}
          ...
          <View style={{ flexDirection: "row", marginTop: 10 }}>
            ...
            >
              ...
              />
              <Text
                style={{ marginRight: 130, fontSize: 20, color: "#353535" }}
              >
                +919831984346
              </Text>
            </TouchableOpacity>
