  ...
  render() {
    return (
      <View style={{paddingBottom:120}}>
        <ScrollView>
         <Image source={{uri:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdU4fVZXLuTveqsFUK3AKL8DJDpn0Z4DMkSb9yeh-VgZaVZhIi'}}style={{ height:100,width:250,marginTop:10,marginLeft:55}}></Image>
        <View style={styles.enclosure}>
      <Text style={styles.container}>STORE ID-207</Text>
      </View>
      
      <Text style={{fontSize:18,color:'black',marginLeft:10,marginTop:20,paddingLeft:18,paddingRight:18}}>FOREVER 21 has seen some remarkable accomplishments over the past 30 years.

With a goal to become an $8 billion company by 2017 and open 600 stores in the next three years, it’ll be exciting to see the company achieve in three years what it initially took 30 years to do.FOREVER 21 is the 5th largest specialty retailer in the United States.

A customer from Toronto named her daughter Tiev Forever Golding because she almost had her baby in a Forever 21 store. Once the child’s passport expires, they plan to legally change her first name to “FOREVER”.</Text>      
      </ScrollView>
