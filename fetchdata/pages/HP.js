  ...
  render() {
    return (
      <View style={{paddingBottom:120}}>
        <ScrollView>
         <Image source={{uri:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT08PsqPNd1kIVn67vFqz46utAs1a7IAhIhGsK1Nh5Iy7pCJU5O'}}style={{ height:100,width:250,marginTop:10,marginLeft:55}}></Image>
        <View style={styles.enclosure}>
      <Text style={styles.container}>STORE ID-305</Text>
      </View>
...
This is our calling. This is a new HP. </Text>      
      </ScrollView>
